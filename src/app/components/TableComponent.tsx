...
import { Dropdown, DropdownButton, Tooltip } from "react-bootstrap";
    ...
    <>
      <div className="space-y-3">
            ...
            <div className="flex flex-row space-x-5 items-center">
              {Bulkactions.map((mtext) => (
                <div onClick={() => bulkSelectedItems(mtext)}>
                  <div className="border-[0.5px] border-[#CED4DA] text-sm text-[#4A4A4A] py-2.5 px-3 rounded-md place-self-center flex cursor-pointer flex-row items-center">
                    {mtext.icon && (
              ...
              <div>
                <button
                  ...
                  className="flex space-x-1 border-[0.5px] border-[#CED4DA] text-sm text-[#4A4A4A] py-2.5 px-3 rounded-md place-self-center mr-2"
              ...
              <div className="flex space-x-3 items-center">
                <span
                  ...
                  className="flex space-x-1 place-self-center cursor-pointer text-[#4A4A4A]"
                >
        ...
        <div className="relative overflow-x-auto">
          <table className="w-full text-[#343A40]">
            <thead
              className={`bg-[#F5F5FA] ${
                showBlueHeader ? "bg-blue text-white" : ""
              }`}
            >
              <tr>
                {/* {showCheckBox && (
                      ...
                      {bulkAction_isChecked.current &&
                        selectedRecord === usersTableData!.length && (
                          <input
                            ...
                            type="checkbox"
                            className="items-center w-3 h-3 p-2 rounded-sm checked:bg-primary appearance-none text-primary focus:bg-primary active:bg-primary"
                          />
                        )}
                      {!bulkAction_isChecked.current && (
                        <input
                          ...
                          checked={bulkAction_isChecked.current}
                          type="checkbox"
                          className="items-center w-3 h-3 p-2 rounded-sm checked:bg-primary
            ...
            {!loading && (
              <tbody className="divide-y divide-gray-400 font-normal">
                {usersTableData?.map((data: any, i) => (
                  <tr>
                    ...
                    {/* {showSerialNumb && (
                      <td className="py-3 px-3 text-sm text-left d-block ">
                        {i + 1}
                      </td>
                    )} */}
                    {tableColum.map((col) => (
                        ...
                        <div className="items-center flex">
                          ...
                          {(col.type === COLUMN_TYPES.Text ||
                            ...
                            data[col.name]?.toString().length > 25 && (
                              <Tooltip content={getCleanText(data[col.name])}>
                                <div
                      ...
                      <td className="py-3 px-3">
                        <div className="items-center flex justify-center ">
                          ...
                          <DropdownButton
                            ...
                            size="sm"
                          >
                            <Dropdown.Item onClick={() => setEditItems(row)}>
                            {/* <Dropdown.Item onClick={(e) => customActionClicked(e, data)}> */}
                              Edit
                            </Dropdown.Item>
                          </DropdownButton>
                        </div>
