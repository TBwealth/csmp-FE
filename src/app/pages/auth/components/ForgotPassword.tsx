...
import { useAccountPasswordReset } from "../../../api/api-services/accountQuery";
...
export function ForgotPassword() {
  ...
  const { mutate, isLoading } = useAccountPasswordReset();
      ...
      mutate(
        ...
        },
        {
          onSuccess: (res: any) => {
            ...
            setLoading(false);
            setStatus(res?.data?.data?.detail);
            setHasErrors(false);
          },
          onError: (res: any) => {
  ...
  return (
    <div className=" w-[80%] md:w-[60%] mx-auto h-96 md:h-screen flex items-center justify-center">
      <form
        className="w-full"
        noValidate
      ...
      >
        <div className="text-center mb-10">
          {/* begin::Title */}
          <h1 className="text-[#373737] font-medium text-[14px]">Forgot Password ?</h1>
          {/* end::Title */}
