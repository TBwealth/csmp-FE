...
const ResultCard = ({ data }: any) => {
  ...
  return (
    <div className="w-full">
      <button
        className={`grid grid-cols-5 border-bottom place-content-center w-[180vw] md:w-full ${
      ...
      >
        <div className="flex items-center col-span-2 gap-6">
          ...
          />
          <p
            className={`font-medium text-[14px] text-start ${
        ...
        <p className="font-medium text-[14px] col-span-2 text-start">
          {data?.rule_code}
        </p>
        <div className="flex items-center justify-between">
          {data?.status_code.toLowerCase() === "failed" ? (
            <p className="text-[#FF161A] font-medium text-start">{`${data?.status_code.slice(
              0,
              1
            )}${data?.status_code.slice(1).toLowerCase()}`}</p>
          ) : (
            <p className="text-[#2AB849] font-medium text-start">{`${data?.status_code.slice(
              0,
              1
            )}${data?.status_code.slice(1).toLowerCase()}`}</p>
          )}
        <button className="flex items-center justify-center">
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.83333 2.66797C5.83333 2.39183 5.60948 2.16797 5.33333 2.16797H2.66667C2.39052 2.16797 2.16667 2.39183 2.16667 2.66797V5.33464C2.16667 5.61078 2.39052 5.83464 2.66667 5.83464C2.94281 5.83464 3.16667 5.61078 3.16667 5.33464V3.87508L5.64645 6.35486C5.84171 6.55012 6.15829 6.55012 6.35355 6.35486C6.54882 6.15959 6.54882 5.84301 6.35355 5.64775L3.87377 3.16797H5.33333C5.60948 3.16797 5.83333 2.94411 5.83333 2.66797Z"
              fill={mode === "dark" ? "#FFFFFF" : "#373737"}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M10.1667 2.66797C10.1667 2.39183 10.3905 2.16797 10.6667 2.16797H13.3333C13.6095 2.16797 13.8333 2.39183 13.8333 2.66797V5.33464C13.8333 5.61078 13.6095 5.83464 13.3333 5.83464C13.0572 5.83464 12.8333 5.61078 12.8333 5.33464V3.87508L10.3536 6.35486C10.1583 6.55012 9.84171 6.55012 9.64645 6.35486C9.45118 6.15959 9.45118 5.84301 9.64645 5.64775L12.1262 3.16797H10.6667C10.3905 3.16797 10.1667 2.94411 10.1667 2.66797Z"
              fill={mode === "dark" ? "#FFFFFF" : "#373737"}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.83333 13.332C5.83333 13.6082 5.60948 13.832 5.33333 13.832H2.66667C2.39052 13.832 2.16667 13.6082 2.16667 13.332V10.6654C2.16667 10.3892 2.39052 10.1654 2.66667 10.1654C2.94281 10.1654 3.16667 10.3892 3.16667 10.6654V12.1249L5.64645 9.64514C5.84171 9.44988 6.15829 9.44988 6.35355 9.64514C6.54882 9.84041 6.54882 10.157 6.35355 10.3523L3.87377 12.832H5.33333C5.60948 12.832 5.83333 13.0559 5.83333 13.332Z"
              fill={mode === "dark" ? "#FFFFFF" : "#373737"}
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M10.1667 13.332C10.1667 13.6082 10.3905 13.832 10.6667 13.832H13.3333C13.6095 13.832 13.8333 13.6082 13.8333 13.332V10.6654C13.8333 10.3892 13.6095 10.1654 13.3333 10.1654C13.0572 10.1654 12.8333 10.3892 12.8333 10.6654V12.1249L10.3536 9.64514C10.1583 9.44988 9.84171 9.44988 9.64645 9.64514C9.45118 9.84041 9.45118 10.157 9.64645 10.3523L12.1262 12.832H10.6667C10.3905 12.832 10.1667 13.0559 10.1667 13.332Z"
              fill={mode === "dark" ? "#FFFFFF" : "#373737"}
            />
          </svg>
        </button>
      ...
      {/* {isOpen && (
        ...
        >
          <div className="grid grid-cols-3 gap-y-4">
            ...
            <p className="text-left col-span-2">{data?.message}</p>
            <p className="font-semibold">Description:</p>
            <p className="text-left col-span-2">{data?.description}</p>
            <p className="font-semibold">Region:</p>
            <p className="text-left col-span-2">{data?.region}</p>
          </div>
          <button
            onClick={() => {
              setIsModalOpen(true);
          ...
          >
            ...
            <div className="w-full">
              ...
              <div className="mt-4 font-medium grid md:grid-cols-3 gap-3 pb-2 border-bottom px-4">
                <p className="font-semibold">Status:</p>
                <p className="text-[#FF161A] md:col-span-2">{data?.status}</p>
                <p>Resource Id:</p>
                <p className="md:col-span-2">sg-04cc9e5ccd9ca7f80</p>
                <p className="font-semibold">Resource:</p>
                <p className="md:col-span-2">{data?.provider}</p>
                <p className="font-semibold">Message:</p>
