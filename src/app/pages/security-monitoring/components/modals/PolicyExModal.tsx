...
const reportSchema = Yup.object().shape({
  ...
  specific_resource: Yup.string().required("Specific Resource is required"),
  comment: Yup.string()
...
const PolicyExModal = ({ isOpen, handleHide, mode }: Props) => {
          ...
          >
            ...
            <div className="w-full">
              <div className="fv-row mb-4 col-sm">
                ...
                <select
                  {...formik.getFieldProps("specific_resource")}
                  className={clsx(
                    "form-control bg-transparent",
                    {
                      "is-invalid":
                        formik.touched.specific_resource &&
                        formik.errors.specific_resource,
                    },
                    {
                      "is-valid":
                        formik.touched.specific_resource &&
