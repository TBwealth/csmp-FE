...
import IACExModal from "./IACExModal";
...
const Card = ({ data, mode }: any) => {
  return (
    <div
      className={`grid grid-cols-10 p-[12px] h-[45px] place-content-center  mb-[8px] border-bottom  ${
    ...
    >
      ...
      <p
        className={`font-semibold px-[2px] w-24 h-fit py-[3px] flex text-[8px] my-auto rounded-full  items-center justify-center ${
          data?.status === "Active"
...
const IACExclusion = ({ goBack, mode }: Props) => {
  ...
  return (
    <div className="px-8 mt-[32px] w-full">
      ...
      <div
        className={`grid grid-cols-10 p-[12px] h-[45px] rounded-t-[16px] mb-[8px] border-bottom  ${
          mode === "dark" ? "bg-lightDark" : "bg-white"
        }`}
      >
        <p className="text-start font-semibold text-[12px]">Exclusion type</p>
        <p className="text-start font-semibold text-[12px]">
          Registry
        </p>
        <p className="text-start font-semibold text-[12px]">Image</p>
