...
const VulScan = ({ goBack, mode }: Props) => {
      ...
      <div className="flex items-center justify-between flex-col md:flex-row gap-[16px]">
        <div className="flex items-center flex-col md:flex-row gap-[16px]">
          <div className="flex items-center gap-[16px] border-end pr-[16px]">
            ...
            <h1 className="font-semibold text-[14px]">Scan IAC / Templates</h1>
          </div>
          <p
            className={`${
              mode === "dark"
      ...
      <div className="flex items-start justify-between w-full md:flex-row gap-[24px] flex-col mt-[32px]">
        ...
        >
          <div className="flex items-center gap-[16px]">
            ...
            <h2 className="font-bold text-[18px]">Scan IAC Template</h2>
          </div>
            ...
            >
              {(form) => (
                <form onSubmit={form.handleSubmit}>
                  ...
                  {/* repo */}
                  <div className="form-group mb-[32px] relative">
                    <label
                      htmlFor="provider"
                      className="flex items-center gap-4 mb-[8px]"
                    >
                    ...
                    <Popover
                      onClickOutside={() => {
                        form.setFieldError("repo_id", "repo id is required");
                      ...
                      content={
                        <div className="w-[24rem] lg:w-[35rem]">
                          ...
                          >
                            <h1 className="font-semibold text-start text-[12px] md:text-[18px] mb-[16px]">
                              Select a Repository
                            </h1>
                              ...
                              {allRepos.length > 0 ? (
                                allRepos.map((repo) => (
                                  <li className="border-start-0">
                                    <button
                                      onClick={() => {
                                        form.setFieldValue("repo_id", repo?.id);
                                        setShowPopUp(false);
                                      }}
                                ...
                                <p className="font-semibold text-center mt-[16px] text-[12px] md:text-[18px]">
                                  No repo found
                                </p>
                              )}
                            </ul>
                  ...
                  <div className="form-group mb-[32px]">
                    <p className="font-semibold text-[14px] text-center mb-[32px]">
                      Or manually upload templates
                    </p>
                    <div className="w-full">
                      <Dragger {...props}>
                        <p className="ant-upload-drag-icon flex items-center justify-center">
                          ...
                          >
                            <path
                              d="M16.5007 29.332V17.332M16.5007 17.332L21.1673 21.9987M16.5007 17.332L11.834 21.9987"
                              stroke="#284CB3"
                              strokeWidth="1.5"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
                            <path
                              d="M27.1673 23.4776C29.1589 22.6975 31.1673 20.9198 31.1673 17.3346C31.1673 12.0013 26.7229 10.668 24.5006 10.668C24.5006 8.0013 24.5006 2.66797 16.5007 2.66797C8.50065 2.66797 8.50065 8.0013 8.50065 10.668C6.27843 10.668 1.83398 12.0013 1.83398 17.3346C1.83398 20.9198 3.84235 22.6975 5.83399 23.4776"
                              stroke="#284CB3"
                              strokeWidth="1.5"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                        ...
                        <p className="ant-upload-hint">
                          Supported format: YAML, JSON, TF, AI
                        </p>
                      </Dragger>
                      <p
                        className={`mt-[8px] font-medium flex text-[10px] items-center justify-start ${
                  ...
                  >
                    {!loading && (
                      <span className="indicatorLabel flex items-center">
                        {newRepo ? "Initiate Scan" : "Scan IAC"}
                        <svg
                          width="20px"
                          height="20px"
                          strokeWidth="1.5"
        ...
        <div className="w-full md:w-[35%]">
          {!scanData ? (
            <div
              className={`rounded-[12px] flex items-center gap-8 justify-center flex-col mb-10 border p-[24px] ${
                mode === "dark" ? "bg-lightDark" : "bg-white"
              }`}
            >
            ...
            <>
              <div
                className={`rounded-[12px] font-medium flex items-center justify-between mb-[18px] border p-6 ${
                  mode === "dark" ? "bg-lightDark" : "bg-white"
                }`}
              >
                <div className="">
              ...
              >
                <div className="w-full px-[24px] py-[16px] border-bottom flex items-center justify-between">
                  ...
                  <h3 className="flex items-center gap-3 font-medium text-[12px]">
                    ...
                    }/${new Date(scanData?.created_on).getFullYear()}`}</span>
                    <span>{`${
                ...
                <div className="w-full px-[24px] py-[16px]">
                  <h3 className="font-medium text-[14px] mb-[16px] text-left">
                  ...
                  <div className="grid grid-cols-3 gap-3 mt-8">
                    <div className="flex items-center justify-center flex-col border-end">
                      ...
                      <p className="font-medium text-[10px] mb-2">compliant</p>
